...
\subsubsection{Soil vs.~Subsurface Geology Weighting
...
\paragraph{Soils}\label{soils}

\begin{Shaded}
\begin{Highlighting}[]
\InformationTok{\textasciigrave{}\textasciigrave{}\textasciigrave{}\{r\}}
\CommentTok{\# Where depth to bedrock (dtb) = 0cm, soil multiplier = 0 (no soil)}
\CommentTok{\# Where depth to dtb \textgreater{}= 200cm, soil multiplier = 1 (Full depth of soil)}
\CommentTok{\# Intermediate depths = linear}
\NormalTok{soilMultiplier }\OtherTok{=}\NormalTok{ masked}
\NormalTok{soilMultiplier[soilMultiplier }\SpecialCharTok{\textgreater{}} \DecValTok{200}\NormalTok{] }\OtherTok{=} \DecValTok{200}  \CommentTok{\# Fix upper limit of soil depth = 200 cm}
\NormalTok{soilMultiplier }\OtherTok{=}\NormalTok{ soilMultiplier}\SpecialCharTok{/}\DecValTok{200}
...
\paragraph{Geology}\label{geology}

\begin{Shaded}
\begin{Highlighting}[]
\InformationTok{\textasciigrave{}\textasciigrave{}\textasciigrave{}\{r\}}
\CommentTok{\# Where dtb \textless{} 200cm, geology multiplier = 0 (soil only)}
\CommentTok{\# Where dtb \textgreater{}= 200cm, geology multiplier = dtb/200 (in units of relative soil depth)}
\NormalTok{geologyMultiplier }\OtherTok{=}\NormalTok{ masked}
\NormalTok{geologyMultiplier[geologyMultiplier }\SpecialCharTok{\textless{}} \DecValTok{200}\NormalTok{] }\OtherTok{=} \DecValTok{0}
\NormalTok{geologyMultiplier }\OtherTok{=}\NormalTok{ geologyMultiplier}\SpecialCharTok{/}\DecValTok{200}
\InformationTok{\textasciigrave{}\textasciigrave{}\textasciigrave{}}
\end{Highlighting}
\end{Shaded}
